...
test-lua-5.1: test-pre
	...
	cd core/src/main/c/ && JAVA_HOME="$(JAVA_HOME_21)" LUA_INC="../../../../lua-source/lua-5.1" LUA_LD="../../../../lua-source/lua-5.1" LUA_LIB="lua" ./make-5.1.sh
...
test-lua-5.2: test-pre
	...
	cd core/src/main/c/ && JAVA_HOME="$(JAVA_HOME_21)" LUA_INC="../../../../lua-source/lua-5.2" LUA_LD="../../../../lua-source/lua-5.2" LUA_LIB="lua" ./make-5.2.sh
...
test-lua-5.3: test-pre
	...
	cd core/src/main/c/ && JAVA_HOME="$(JAVA_HOME_21)" LUA_INC="../../../../lua-source/lua-5.3" LUA_LD="../../../../lua-source/lua-5.3" LUA_LIB="lua" ./make-5.3.sh
...
test-lua-latest: test-pre
	...
	cd core/src/main/c/ && JAVA_HOME="$(JAVA_HOME_21)" LUA_INC="../../../../lua-source/lua-latest" LUA_LD="../../../../lua-source/lua-latest" LUA_LIB="lua" ./make-5.3.sh
...
test-lua-luajit: test-pre
	...
	cd core/src/main/c/ && JAVA_HOME="$(JAVA_HOME_21)" LUA_INC="../../../../lua-source/luajit/install/include/luajit-2.1" LUA_LD="../../../../lua-source/luajit/install/lib" LUA_LIB="luajit-5.1" ./make-luajit.sh
...
test-lua-openresty: test-pre
	...
	cd core/src/main/c/ && JAVA_HOME="$(JAVA_HOME_21)" LUA_INC="../../../../lua-source/openresty/install/include/luajit-2.1" LUA_LD="../../../../lua-source/openresty/install/lib" LUA_LIB="luajit-5.1" ./make-openresty.sh
...
test-lua-ravi: test-pre
	...
	cd core/src/main/c/ && JAVA_HOME="$(JAVA_HOME_21)" LUA_INC="../../../../lua-source/ravi/include" LUA_LD="../../../../lua-source/ravi/build" LUA_LIB="ravi" ./make-5.3.sh
